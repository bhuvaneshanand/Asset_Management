...
const AddServiceRequestAdmin = () => {
    ...
    const requestStatusOption = ['Pending', 'In Progress', 'Completed']
        ...
        <div className="container">
            ...
            <Form onSubmit={handleSaveOrUpdate} style={{ paddingBottom: '25px' }}>
                ...
                <div className='text-center'>
                    ...
                    <br />
                    <br />
                    <Link to="/service-requests" className="btn btn-danger" style={{ width: '250px' }}>Cancel</Link>
                </div>
            </Form>
        </div>
        </div>
...
export default AddServiceRequestAdmin;
